    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-4">
          <Link
            to="/lost"
            className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition"
          >
            &larr; {t('backToLostItems') || 'Back to Lost Items'}
          </Link>
        </div>
        ...
        >
          ...
          {message && (
            <div className="mb-4 p-3 bg-green-100 dark:bg-emerald-500/10 text-green-700 dark:text-emerald-300 text-sm rounded-xl text-center font-medium">
              ...
              <div className="mt-3">
                <Link to="/lost" className="underline font-semibold">
                  {t('viewLostItems') || 'View Lost Items'}
                </Link>
              </div>
            </div>
          )}
