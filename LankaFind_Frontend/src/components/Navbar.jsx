...
function Navbar() {
  ...
  return (
    <nav className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg shadow-md dark:shadow-black/30 sticky top-0 z-50 border-b border-transparent dark:border-amber-500/20 transition-colors">
